...
class Estudiante
{
    ...
    public function FiltrarEstudiante($id)
    {
      ...
      $resultado = $nuevoComando->query("Select * from controlestudiantes where idEstudiantes=$id");
      return $resultado;
    }
    ...
    public function EditarEstudiante($id,$apel,$nom,$dir,$tel)
    {
      $nuevaConexion = new conexion();
      $nuevoComando = $nuevaConexion->Conectar();
      $nuevoComando->query("Update controlestudiantes set apellidos="."'".$apel."',nombre="."'".$nom."',direccion="."'".$dir."',telefono="."'".$tel."'"." where idEstudiantes = $id");
    }
    ...
    public function EliminarEstudiante($id,$apel,$nom,$dir,$tel)
    {
      $nuevaConexion = new conexion();
      $nuevoComando = $nuevaConexion->Conectar();
      $nuevoComando->query("Delete From controlestudiantes where idEstudiantes = $id");
    }
}
