    ...
    <?php
        ...
        {?>
          <tr>
                ...
                <td><a href="VistaEditarEstudiante.php?idEst=<?php echo $Estudiantes['idEstudiantes'];?>"><img src="editar.png" alt="Editar" title="Editar"></a></td>
                <td><a href="eliminar.php?idEst=<?php echo $Estudiantes['idEstudiantes'];?>"><img src="eliminar.png" alt="Eliminar" title="Eliminar"></a></td>
